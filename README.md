...
After 14 years building fraud prevention infrastructure at Banamex/Citibanamex — migrating from IBM Mainframe to Actimize IFM, validating 500 TPS under stress, and maintaining ≤1.6s SLA on real-time authorization APIs — I wanted to translate that domain knowledge into a cloud-native implementation using AWS serverless and modern DevOps tooling.
